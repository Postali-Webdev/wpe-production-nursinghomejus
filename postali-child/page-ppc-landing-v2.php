		...
		<div class="container intro-container">
			<div class="columns">
				<div class="column-50">
					...
					<a href="tel:<?php the_field('header_cta_phone'); ?>" title="Call Today" class="btn yellow"><?php the_field('header_cta_phone'); ?></a>
				</div>
                <div class="column-50">
                    <?php echo do_shortcode( get_field('header_form_embed') ); ?>
                </div>
			</div>
		<div>
	</section>  
		...
		<div class="container skinny">
			<div class="columns">
				<div class="column-50 first">
					...
					<a href="tel:<?php the_field('footer_cta_phone'); ?>" title="Call Today" class="btn yellow"><?php the_field('footer_cta_phone'); ?></a>
				</div>
				<div class="column-50">
